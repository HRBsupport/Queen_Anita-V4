...
global.anitav4 = process.env.BOT_NAME || "HONORSBOT-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "ZERO OF HONORS";
global.packname = process.env.PACK_NAME || "HONORSBOT-𝐕𝟒";
global.author = process.env.AUTHOR || "HONORSBOT";
global.channelname = process.env.CHANNEL_NAME || "HONORSBOT";
